...
public class LerVarException extends Exception {
    ...
    public static void _LerVarExceptionInspect() throws Exception {
        com.lervar.interfaces.LerVarInterfacesException._LerVarInterfacesExceptionInspect();
        _LerVarClassExceptionInspect();
    }
    public static void _LerVarClassExceptionInspect() throws Exception {
